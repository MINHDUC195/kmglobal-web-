...
|----------|----------------------|
| Giảm giá khóa học | `20260321100000_regular_courses_discount.sql`, `RUN_MIGRATION_DISCOUNT.sql` |
| Khóa % giảm sau clone | `20260324140000_regular_courses_discount_locked.sql` |
| Mẫu chứng chỉ / bucket | `RUN_MIGRATION_CERTIFICATE_SAMPLE.sql`, migration `*_certificate_*` |
