-- =============================================================================
-- Chạy trong Supabase SQL Editor nếu chưa áp migration 20260320150000
-- Pessimistic locking cho lesson/chapter (tránh ghi đè khi 2 admin sửa cùng lúc)
-- =============================================================================
...
drop policy if exists "edit_locks_admin_select" on public.edit_locks;
...
drop policy if exists "edit_locks_admin_all" on public.edit_locks;
